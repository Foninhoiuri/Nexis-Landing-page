...
import { FooterSkeleton } from "@/components/PageSkeletons";
...
export function Footer() {
    return (
        <footer className="relative text-white py-10 overflow-hidden bg-black">
                        ...
                        <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
                            ...
                            <div className="space-y-6">
                                ...
                                <ul className="space-y-3">
                                    {NAV_LINKS.map((link) => (
                                        <li key={link.id}>
                                            <a href={link.href || `/#${link.id}`} className="flex items-center gap-2 text-white/60 hover:text-white transition-colors text-base">
                                                {link.label}
                                            </a>
                                        </li>
                                    ))}
