...
function TwitterIcon() {
    return (
        <svg className="w-5 h-5 hover:text-white transition-colors cursor-pointer" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
...
export function Footer() {
    return (
        <footer className="py-12 border-t border-white/5 bg-black">
            <div className="container mx-auto px-4 grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
                <div className="col-span-2 md:col-span-1">
                    <div className="flex items-center gap-2 mb-4">
                        <div className="w-6 h-6 rounded-md bg-white/10 flex items-center justify-center text-white text-xs font-bold">N</div>
                        <span className="text-white font-semibold">Nexis</span>
                    </div>
                    <p className="text-neutral-500 text-sm">
                        Next-generation infrastructure specifically designed for the modern web.
                    </p>
                </div>
                <div>
                    ...
                    <ul className="space-y-2 text-sm text-neutral-500">
                        ...
                        <li><a href="#" className="hover:text-brand transition-colors">Integration</a></li>
            ...
            <div className="container mx-auto px-4 pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-neutral-600">
                <p>© 2024 Nexis Inc. All rights reserved.</p>
