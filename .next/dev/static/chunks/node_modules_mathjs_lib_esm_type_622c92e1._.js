...
var createRangeClass = /* #__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mathjs$2f$lib$2f$esm$2f$utils$2f$factory$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["factory"])(name, dependencies, ()=>{
   ...
   */ function Range(start, end, step) {
        ...
        if (hasStep && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mathjs$2f$lib$2f$esm$2f$utils$2f$number$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["nearlyEqual"])(this.step, 0)) {
...
var createDenseMatrixClass = /* #__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mathjs$2f$lib$2f$esm$2f$utils$2f$factory$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["factory"])(name, dependencies, (_ref)=>{
   ...
   */ function _getSubmatrix(data, index) {
        ...
        function getSubmatrixRecursive(data) {
            ...
            function _mapIndex(dim, callback) {
                ...
                if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mathjs$2f$lib$2f$esm$2f$utils$2f$is$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isNumber"])(dim)) return callback(dim);
                else return dim.map(callback).valueOf();
            }
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mathjs$2f$lib$2f$esm$2f$utils$2f$is$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isNumber"])(dims)) {
                size[depth] = null;
            } else {
            ...
            if (depth < maxDepth) {
                return _mapIndex(dims, (dimIndex)=>{
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mathjs$2f$lib$2f$esm$2f$utils$2f$array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["validateIndex"])(dimIndex, data.length);
   ...
   */ function _set(matrix, index, submatrix, defaultValue) {
        ...
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mathjs$2f$lib$2f$esm$2f$utils$2f$is$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isMatrix"])(submatrix)) {
            ...
            submatrixSize = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mathjs$2f$lib$2f$esm$2f$utils$2f$array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["arraySize"])(submatrix);
        }
        if (isScalar) {
            // set a scalar
            ...
            // set a submatrix
            // broadcast submatrix
            if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mathjs$2f$lib$2f$esm$2f$utils$2f$object$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deepStrictEqual"])(submatrixSize, iSize)) {
                if (submatrixSize.length === 0) {
            ...
            if (submatrixSize.length < iSize.length) {
                ...
                submatrix = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mathjs$2f$lib$2f$esm$2f$utils$2f$array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["unsqueeze"])(submatrix, iSize.length, outer, submatrixSize);
            }
            // check whether the size of the submatrix matches the index size
            if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mathjs$2f$lib$2f$esm$2f$utils$2f$object$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deepStrictEqual"])(iSize, submatrixSize)) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mathjs$2f$lib$2f$esm$2f$error$2f$DimensionError$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DimensionError"](iSize, submatrixSize, '>');
            }
            // enlarge matrix when needed
   ...
   */ function _setSubmatrix(data, index, submatrix) {
        ...
        function setSubmatrixRecursive(data, submatrix) {
            ...
            if (depth < maxDepth) {
                if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mathjs$2f$lib$2f$esm$2f$utils$2f$is$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isNumber"])(range)) recursiveCallback(range, [
                    0
                ]);
                else range.forEach(recursiveCallback);
            } else {
                if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mathjs$2f$lib$2f$esm$2f$utils$2f$is$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isNumber"])(range)) finalCallback(range, [
                    0
                ]);
   ...
   */ SparseMatrix.prototype.subset = function(index, replacement, defaultValue) {
    ...
    function _setsubset(matrix, index, submatrix, defaultValue) {
        ...
        function _forEachIndex(index, callback) {
            ...
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mathjs$2f$lib$2f$esm$2f$utils$2f$is$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isNumber"])(index)) callback(index, [
                0
            ]);
...
var createIndexClass = /* #__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mathjs$2f$lib$2f$esm$2f$utils$2f$factory$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["factory"])(name, dependencies, (_ref)=>{
   ...
   */ Index.prototype.type = 'Index';
    ...
    function _createImmutableMatrix(arg) {
        ...
        for(var i = 0, l = arg.length; i < l; i++){
            if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mathjs$2f$lib$2f$esm$2f$utils$2f$is$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isNumber"])(arg[i]) || !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mathjs$2f$lib$2f$esm$2f$utils$2f$number$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isInteger"])(arg[i])) {
   ...
   */ Index.prototype.size = function() {
        ...
        for(var i = 0, ii = this._dimensions.length; i < ii; i++){
            ...
            size[i] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mathjs$2f$lib$2f$esm$2f$utils$2f$is$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isString"])(d) || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mathjs$2f$lib$2f$esm$2f$utils$2f$is$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isNumber"])(d) ? 1 : d.size()[0];
        }
        return size;
    };
    /**
   ...
   */ Index.prototype.max = function() {
        ...
        for(var i = 0, ii = this._dimensions.length; i < ii; i++){
            ...
            values[i] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mathjs$2f$lib$2f$esm$2f$utils$2f$is$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isString"])(range) || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mathjs$2f$lib$2f$esm$2f$utils$2f$is$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isNumber"])(range) ? range : range.max();
        }
        return values;
    };
    /**
   ...
   */ Index.prototype.min = function() {
        ...
        for(var i = 0, ii = this._dimensions.length; i < ii; i++){
            var range = this._dimensions[i];
            values[i] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mathjs$2f$lib$2f$esm$2f$utils$2f$is$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isString"])(range) || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mathjs$2f$lib$2f$esm$2f$utils$2f$is$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isNumber"])(range) ? range : range.min();
        }
        return values;
    };
    /**
   ...
   */ Index.prototype.isObjectProperty = function() {
        return this._dimensions.length === 1 && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mathjs$2f$lib$2f$esm$2f$utils$2f$is$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isString"])(this._dimensions[0]);
    };
    /**
   ...
   */ Index.prototype.toArray = function() {
        ...
        for(var i = 0, ii = this._dimensions.length; i < ii; i++){
            ...
            array.push((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mathjs$2f$lib$2f$esm$2f$utils$2f$is$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isString"])(dimension) || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mathjs$2f$lib$2f$esm$2f$utils$2f$is$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isNumber"])(dimension) ? dimension : dimension.toArray());
        }
        return array;
    };
    /**
   ...
   */ Index.prototype.toString = function() {
        ...
        for(var i = 0, ii = this._dimensions.length; i < ii; i++){
            var dimension = this._dimensions[i];
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mathjs$2f$lib$2f$esm$2f$utils$2f$is$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isString"])(dimension)) {
...
//# sourceMappingURL=node_modules_mathjs_lib_esm_type_622c92e1._.js.map